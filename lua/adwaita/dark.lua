...
M.set = function()
    ...
    hl('IncSearch', { fg = colors.dark_6, bg = colors.blue_2 })
    hl('LineNr', { fg = colors.dark_2, bg = colors.libadwaita_dark })
    hl('CursorLineNr', { fg = colors.light_7 })
    hl('MatchParen', { fg = colors.orange_2, bold = true })
    ...
    hl('Search', { fg = colors.dark_6, bg = colors.blue_2 })
    hl('SpecialKey', { fg = colors.dark_2, bg = colors.libadwaita_dark })
    hl('StatusLine', { fg = colors.light_4, bg = colors.libadwaita_tree })
    ...
    hl('Title', { bold = true })
    hl('Visual', { bg = colors.blue_8 })
    hl('VisualNOS', { bg = colors.blue_8 })
    ...
    hl('TelescopeSelection', { bg = colors.libadwaita_dark_alt, bold = true })
    hl('TelescopeMultiSelection', { fg = colors.light_4, })
    hl('TelescopeMatching', { fg = colors.blue_2 })
    hl('TelescopePromptPrefix', { fg = colors.light_4, bold = true })
    hl('TelescopeTitle', { fg = colors.blue_2, bold = true })
    ...
    hl('LspReferenceText', { bg = colors.dark_2 })
    hl('LspReferenceRead', { bg = colors.dark_2 })
    hl('LspReferenceWrite', { bg = colors.dark_2 })
    ...
    -- Indent-Blankline
    hl('IblIndent', { fg = colors.dark_4 })
    hl('IblWhitespace', { fg = colors.dark_4 })
    hl('IblScope', { fg = colors.dark_2 })
end
